...
--         ["1"] = {["now"] = "1", ["name"] = "生成任务", ["class"] = Login, ["method"] = "restartGame", ["next"] = "2"},
--         ["2"] = {["now"] = "2", ["name"] = "重启游戏", ["class"] = Login, ["method"] = "restartGame", ["next"] = "3"},
--         ["3"] = {
--             ["now"] = "3",
--             ["name"] = "等登录界面",
--             ["class"] = Login,
...
--             ["next"] = "4"
--         },
--         ["4"] = {["now"] = "4", ["name"] = "账号类型", ["class"] = Login, ["method"] = "accountType", ["next"] = "5"},
--         ["5"] = {["now"] = "5", ["name"] = "账号密码", ["class"] = Login, ["method"] = "inputAccountPasswd", ["next"] = "6"},
--         ["6"] = {["now"] = "6", ["name"] = "选区", ["class"] = Login, ["method"] = "selectServer", ["next"] = "7"},
--         ["7"] = {["now"] = "7", ["name"] = "关闭弹窗", ["class"] = Login, ["method"] = "closeWindow", ["next"] = "1"}
--     }
--     return page
-- end
