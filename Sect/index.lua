...
local function dialogSelection()
    offset = "0|28|0xeacca7,237|31|0xeac395,234|-1|0xf4dec0"
    return findColorsUntil(0xf4ddc0, offset, 90, 810, 81, 1111, 490, {orient = 2}, 500, 1)
end
...
function Sect.crashCallack()
    ...
    if nowNode == 1 then --回长安
        return 2
    elseif nowNode == 2 then --打开活动面板
        return 2
    elseif nowNode == 3 then --查找任务并打开
        return 2
    elseif nowNode == 4 then --选择任务
        return 2
    elseif nowNode == 5 then --等师傅
        return 2
    elseif nowNode == 6 then --找任务
        return 6
    elseif nowNode == 7 then --执行
        return 6
    end
end
return Sect
