...
function Treasure.crashCallack()
    ...
    elseif nowNode == 3 then --查找任务并打开
        return 2
    elseif nowNode == 4 then --等店小二
        return 2
    elseif nowNode == 5 then --领取任务
        return 2
    elseif nowNode == 6 then --右侧查找任务
        ret, tim, x, y = rightTask()
        -- 找到任务
        if ret then
            tap(x, y)
    ...
    elseif nowNode == 7 then --等待打宝图
        ...
        -- 打开背包
        return 8
    elseif nowNode == 8 then --打开背包
        return 8
    elseif nowNode == 9 then --查找宝图
        return 8
    elseif nowNode == 10 then --使用宝图
        return 8
    end
end
