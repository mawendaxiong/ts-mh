...
function page.index()
    ...
    page = {
        ...
        ["4"] = {["now"] = "4", ["name"] = "等云乐游", ["class"] = mijing, ["method"] = "waitNPC", ["next"] = "5"},
        ["5"] = {["now"] = "5", ["name"] = "进入秘境", ["class"] = mijing, ["method"] = "getInto", ["next"] = "6"},
        ["6"] = {["now"] = "6", ["name"] = "计算次数", ["class"] = mijing, ["method"] = "count", ["next"] = "1"}
    }
